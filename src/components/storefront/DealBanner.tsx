...
export default function DealBanner({
  ...
  return (
    <div data-nosnippet className={`relative overflow-hidden rounded-md bg-gradient-to-r ${gradient} p-6 sm:p-10 md:p-16 shadow-2xl min-h-[300px] sm:min-h-[380px] md:min-h-[450px] flex items-center`}>
      ...
      <div className="relative z-10 max-w-2xl space-y-4 sm:space-y-6">
        ...
        <div className="pt-2">
          <Link
            href={linkUrl}
            className="inline-flex items-center gap-2.5 sm:gap-3 bg-white px-6 py-3 sm:px-8 sm:py-4 text-xs sm:text-sm font-black uppercase tracking-widest text-zinc-950 shadow-xl transition-all hover:bg-primary hover:text-white group"
          >
            {linkText}
